export class Visualize {
    ...
    drawBox(color, boxIndex) {
        const xPos = (boxIndex%3)*(this.boxWidth+this.boxBorder);
        const yPos = (Math.floor(boxIndex/3))*(this.boxWidth+this.boxBorder);
  
        this.ctx.fillStyle = color;
        this.ctx.fillRect(xPos,yPos,this.boxWidth+1,this.boxWidth+1);
    }
